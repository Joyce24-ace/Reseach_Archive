...
# 1. BASE_DIR must come first so we can find the absolute path
BASE_DIR = Path(__file__).resolve().parent.parent

# 2. Pinpoint the .env file explicitly
ENV_PATH = os.path.join(BASE_DIR, '.env')
load_dotenv(dotenv_path=ENV_PATH)

# Optional Debug Check: This prints a message to your terminal if the file is missing
if not os.path.exists(ENV_PATH):
    print(f"⚠️  CRITICAL: .env file not found at: {ENV_PATH}")
...
ALLOWED_HOSTS = ['reseach-archive.onrender.com', '127.0.0.1', 'localhost']
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@scholarvault.app')
...
AXES_COOLOFF_TIME = timedelta(hours=1)                   # unlock after 1 hour (timedelta or int hours)
...
# Cloudinary Settings
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': os.getenv('CLOUDINARY_CLOUD_NAME', 'dgvy0orf7'),
    'API_KEY': os.getenv('CLOUDINARY_API_KEY', '822438274731574'),
    'API_SECRET': os.getenv('CLOUDINARY_API_SECRET', 'hUFKl0ANxmCFoC0uB6-2BYeFKCc'),
}

# Ensure PDFs handle cleanly
